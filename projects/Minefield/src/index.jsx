...
export default function Minefiled() {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <Header flagsLeft={minesAmount - flagUsed(board)} onNewGame={()=> newGame()}/>
